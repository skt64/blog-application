...
// cheacking for user logged in or not
...
// cheacking for existing blog edits

let blogID = location.pathname.split("/");
blogID.shift(); // it will remove first elementas which is empty from the array

if(blogID[0] != "editor"){
    // means we aren in existing blog edit route
